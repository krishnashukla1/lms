...
//   const [exam, setExam] = useState({ questions: [] }); // default to empty questions
//   const [loading, setLoading] = useState(false);

//   // Fetch exam when courseType changes
//   useEffect(() => {
//     fetchExam();
//   }, [courseType]);

//   // GET exam by courseType
//   const fetchExam = async () => {
//     try {
//       setLoading(true);
//       const res = await api.get("/final-exams/admin/all"); // fetch all exams
//       const courseExam = res.data.find((e) => e.courseType === courseType);
//       if (courseExam) {
//         setExam(courseExam);
//       } else {
//         setExam({ courseType, questions: [] }); // no exam yet for this course
//       }
//     } catch (err) {
...
//       await api.post(`/final-exams/${courseType}`, {
...
//   return (
//     <div className="p-10 min-h-screen bg-linear-to-br from-blue-50 via-white to-indigo-100">
//       <h1 className="text-4xl font-black text-indigo-700 mb-10">
//         Final Exam – Admin Panel
//       </h1>

//       {/* Course Selection */}
//       <div className="mb-8">
//         <label className="mr-3 font-bold text-lg">Select Course:</label>
//         <select
...
//               <div
//                 key={i}
//                 className="bg-white shadow-xl p-6 rounded-2xl border-2 border-gray-100"
//               >
//                 <div className="flex justify-between items-center">
//                   <h3 className="text-xl font-bold">Question {i + 1}</h3>
//                   <button
...
//                   {q.options.map((opt, j) => (
//                     <div key={j}>
//                       <label className="block font-medium">Option {j + 1}</label>
//                       <input
//                         type="text"
...
//           <button
//             onClick={addQuestion}
//             className="mt-8 px-6 py-3 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700"
//           >
//             + Add Question
//           </button>
...
//           <button
//             onClick={saveExam}
//             className="mt-8 ml-6 px-8 py-3 bg-emerald-600 text-white font-bold rounded-xl hover:bg-emerald-700"
//           >
//             Save Final Exam
//           </button>
//         </div>
