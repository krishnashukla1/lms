...
// router.post("/", auth, upload.single("assignment"), uploadAssignment);           // Student upload
// router.get("/", auth, getAllAssignments);                                        // Admin: list all
// router.get("/:id/file", auth, getAssignmentFile);                                // Admin: download file
// router.delete("/:id", auth, deleteAssignment);                                   // Admin: delete
// router.get("/assignment-status", auth, getAssignmentStatus);                     // Student: check status
