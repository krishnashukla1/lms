...
//   const startEdit = (s) => {
//     setEditing(s);
//     setForm({ name: s.name, username: s.username, password: "" }); // empty password for reset
//   };
...
//         </button>
//         <h1 className="text-3xl font-bold text-blue-600 mb-6">👨‍🎓 Student List</h1>

//         <input
//           type="text"
//           placeholder="Search by name or username..."
//           className="w-full p-3 rounded-lg border mb-6 focus:ring-2 focus:ring-blue-400"
//           value={search}
...
//                 </tr>
//               ) : filtered.map((s) => (
//                 <tr key={s._id} className="hover:bg-blue-50 border-b">
...
//                 <input
//                   type="password"
//                   placeholder="Reset Password (leave blank to keep)"
//                   className="w-full p-3 border rounded"
//                   value={form.password}
