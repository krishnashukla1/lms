...
//   const handleSubmit = () => {
//     if (!selected.studentId || !selected.courseType) {
...
//         <button
//           onClick={() => {
//             setSelected({ id: "", studentId: "", courseType: "" });
//             setOpen(true);
//           }}
...
//                 <td className="p-3 capitalize">{en.courseType}</td>
...
//                     onClick={() => deleteMutation.mutate(en._id)}
//                   />
//                 </td>
//               </tr>
//             ))}
...
//   const [open, setOpen] = useState(false);
//   const [selected, setSelected] = useState({ id: "", studentId: "", courseType: "" });
...
//       updateMutation.mutate({
//         id: selected.id,
//         payload: { courseType: selected.courseType },
//       });
//     } else {
//       createMutation.mutate({
//         studentId: selected.studentId,
...
//           <h1 className="text-4xl font-black text-center text-transparent bg-clip-text bg-linear-to-r from-indigo-600 to-purple-600">
//             Manage Enrollments
//           </h1>
//         </div>
//       </div>
...
//         {/* New Enrollment Button - Right */}
//         <button
//           onClick={() => {
//             setSelected({ id: "", studentId: "", courseType: "" });
//             setOpen(true);
//           }}
//           className="cursor-pointer flex items-center gap-2 bg-linear-to-r from-indigo-600 to-purple-600 text-white px-5 py-3 rounded-2xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
//         >
...
//       {/* Table Card */}
//       <div className="max-w-7xl mx-auto bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-x-auto border border-gray-200/50">
...
//           <tbody>
//             {enrollments.map((en) => (
//               <tr key={en._id} className="border-t hover:bg-gray-50 transition-all">
//                 <td className="p-4">
//                   <div className="font-semibold">{en.student?.name}</div>
//                   <div className="text-sm text-gray-500">{en.student?.email}</div>
//                 </td>
//                 <td className="p-4 capitalize font-medium">{en.courseType}</td>
//                 <td className="p-4">{format(new Date(en.enrolledAt), "dd MMM yyyy")}</td>
//                 <td className="p-4">{format(new Date(en.expiresAt), "dd MMM yyyy")}</td>
//                 <td className="p-4">
//                   {en.isActive ? (
//                     <span className="text-green-600 font-semibold">Active</span>
//                   ) : (
...
//           <button
//             onClick={() => navigate(-1)}
//             className="flex items-center gap-2 px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-xl text-gray-700 font-medium"
//           >
...
//         {/* Table */}
//         <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 overflow-x-auto">
...
//                           expiresAt: en.expiresAt.split("T")[0],
