...
// import { FiArrowLeft, FiAward, FiBookOpen, FiLock, FiCheckCircle } from "react-icons/fi";
...
//                     ${isCompleted ? "bg-emerald-500 text-white" : isNext ? "bg-linear-to-r from-amber-500 to-orange-500 text-white animate-pulse" : "bg-gray-500 text-white"}`}>
...
//============with 3 card current module,next module and assignment submission card========
...
//         const filtered = allModules.filter(m => (m.courseType || "basic") === courseType);
//         setModules(filtered);
...
//       el.scrollIntoView({ behavior: "smooth", block: "center" });
//       el.classList.add("ring-8", "ring-amber-400", "ring-opacity-70");
//       setTimeout(() => el.classList.remove("ring-8", "ring-amber-400", "ring-opacity-70"), 3000);
//     }
//   }, [loading, highlightModuleId]);
...
//   // === CALCULATE STATS FOR THIS COURSE ONLY ===
...
//             initial={{ opacity: 0, y: 20 }}
//             animate={{ opacity: 1, y: 0 }}
//             className="backdrop-blur-xl bg-white/70 rounded-3xl shadow-xl border border-white/30 p-8 flex flex-col"
//           >
//             <div className="flex items-center justify-between mb-6">
//               <div className="p-4 bg-indigo-100 rounded-2xl">
//                 <FiBarChart2 className="text-indigo-600 text-3xl" />
//               </div>
//               <span className="text-4xl font-bold text-indigo-600">{progressPercentage}%</span>
//             </div>
//             <h3 className="font-bold text-gray-800 text-xl mb-4">Progress in this Course</h3>
//             <div className="w-full bg-gray-200/70 rounded-full h-4 overflow-hidden mb-4">
//               <motion.div
//                 initial={{ width: 0 }}
...
//             className="backdrop-blur-xl bg-linear-to-br from-amber-500/20 to-orange-500/20 rounded-3xl shadow-xl border border-amber-200/50 p-8 flex flex-col"
//           >
//             <div className="flex items-center gap-4 mb-6">
//               <div className="p-4 bg-amber-100 rounded-2xl">
//                 <FiTarget className="text-amber-600 text-3xl" />
//               </div>
//               <h3 className="font-bold text-gray-800 text-xl">Next Up</h3>
//             </div>
//             <p className="font-bold text-2xl text-gray-800 line-clamp-2 flex-1">
//               {nextModule ? nextModule.title : "All modules completed!"}
//             </p>
//             <p className="text-gray-600 mt-3">
//               {nextModule ? "Ready to continue your journey" : "Amazing work! Course finished"}
//             </p>
//           </motion.div>
...
//             className="backdrop-blur-xl bg-linear-to-br from-emerald-500/20 via-teal-500/20 to-cyan-500/20 rounded-3xl shadow-xl border border-emerald-300/40 p-8 flex flex-col"
//           >
//             <div className="flex flex-col items-center justify-center flex-1 text-center">
//               <div className="p-5 bg-emerald-100 rounded-full mb-5">
//                 <FiFileText className="text-5xl text-emerald-600" />
//               </div>
//               <h3 className="text-2xl font-bold text-gray-800 mb-3">Final Assignment</h3>
//               <p className="text-gray-600 mb-8">One-time submission for the course</p>

//               {hasSubmitted ? (
//                 <div className="inline-flex items-center gap-4 px-10 py-5 bg-emerald-500 text-white font-bold text-xl rounded-3xl shadow-lg">
...
//                   className="inline-flex items-center gap-4 px-10 py-6 bg-linear-to-r from-emerald-500 to-teal-600 text-white font-bold text-xl rounded-3xl shadow-2xl hover:shadow-emerald-500/50 transition-all"
//                 >
...
//                         if (isVideo) {
//                           return (
//                             <motion.div key={i} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-200">
//                               <div className="p-6 bg-linear-to-r from-indigo-50 to-purple-50">
//                                 <h4 className="text-2xl font-bold text-indigo-700 mb-4 flex items-center gap-3">
//                                   Video {i + 1} — {title}
//                                 </h4>
...
// import api from "../api/axios";
// import { FiArrowLeft, FiCheckCircle, FiUpload, FiFileText, FiBookOpen ,FiAward } from "react-icons/fi";
// import { motion } from "framer-motion";
...
//         const enrolled = enrollRes.data.activeCourses?.some(c => c.courseType === courseType) || false;
//         setIsEnrolled(enrolled);

//         setHasSubmittedAssignment(assignRes.data[courseType]?.submitted || false);

//         const result = examRes.data.results?.find(r => r.courseType === courseType) || null;
...
//     );
//   }
// console.log("Current User Role:", localStorage.getItem("user") ? JSON.parse(localStorage.getItem("user")).role : "No user");
//   if (!isEnrolled) {
//     return (
//       <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-indigo-50 to-purple-100">
//         <div className="text-center">
//           <h1 className="text-4xl font-bold text-gray-800 mb-4">Not Enrolled</h1>
//           <p className="text-xl text-gray-600 mb-8">You are not enrolled in this course.</p>
//           <button
//             onClick={() => navigate("/student")}
...
//         {/* Assignment and Exam Cards (Side by Side) */}
...
//           {/* Final Exam Card (Right Side) */}
//           <motion.div
//             initial={{ opacity: 0, y: 20 }}
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ delay: 0.3 }}
//             className="backdrop-blur-xl bg-linear-to-br from-purple-500/20 via-fuchsia-500/20 to-pink-500/20 rounded-3xl shadow-xl border border-purple-300/40 p-8 flex flex-col"
//           >
//             <div className="flex flex-col items-center justify-center flex-1 text-center">
//               <div className="p-5 bg-purple-100 rounded-full mb-5">
//                 <FiBookOpen className="text-5xl text-purple-600" />
//               </div>
//               <h3 className="text-2xl font-bold text-gray-800 mb-3">Final Exam</h3>
//               <p className="text-gray-600 mb-8">One-time exam for the course</p>
//               {examResult ? (
//                 <div className={`inline-flex items-center gap-4 px-10 py-5 rounded-3xl shadow-lg font-bold text-xl text-white ${examResult.passed ? "bg-emerald-500" : "bg-red-500"}`}>
//                   <FiCheckCircle className="text-3xl" />
//                   {examResult.passed ? "Passed" : "Failed"} ({examResult.score}%)
//                 </div>
//               ) : (
//                 <motion.button
//                   whileHover={{ scale: 1.05 }}
...
//                   className="inline-flex items-center gap-4 px-10 py-6 bg-linear-to-r from-purple-500 to-fuchsia-600 text-white font-bold text-xl rounded-3xl shadow-2xl hover:shadow-purple-500/50 transition-all"
//                 >
...
//         {/* Placeholder for Modules (since no backend, show message) */}
//         <div className="text-center p-12 bg-white rounded-3xl shadow-xl">
//           <h2 className="text-4xl font-bold text-gray-800 mb-6">Course Modules</h2>
//           <p className="text-xl text-gray-600">Modules not available yet. Complete assignment and exam to finish the course.</p>
//         </div>
//       </div>
//     </div>
//   );
...
// import { useParams, useNavigate, useLocation } from "react-router-dom";
// import api from "../api/axios";
// import { FiArrowLeft, FiAward, FiBookOpen, FiLock, FiBarChart2, FiTarget, FiFileText, FiUpload, FiCheckCircle } from "react-icons/fi";
// import { motion } from "framer-motion";
// import VideoEmbed from "../components/VideoEmbed";
...
//   //   const fetchData = async () => {
//   //     try {
//   //       // Fetch enrollment, assignment, exam status
//   //       const [enrollRes, assignRes, examRes, dashRes] = await Promise.all([
//   //         api.get("/enrollments/my"),
//   //         api.get("/final-assignments/assignment-status"),
//   //         api.get("/final-exams/results/my"),
//   //         api.get("/student/dashboard"), // Your module source
//   //       ]);

//   //       const enrolled = enrollRes.data.activeCourses?.some(c => c.courseType === courseType) || false;
//   //       setIsEnrolled(enrolled);

//   //       setHasSubmittedAssignment(assignRes.data[courseType] || false);

//   //       const result = examRes.data.results?.find(r => r.courseType === courseType);
//   //       setExamResult(result);

//   //       // Load modules from dashboard
//   //       const allModules = dashRes.data.modules || [];
//   //       const filtered = allModules.filter(m => (m.courseType || "basic") === courseType);
//   //       setModules(filtered);
...
//     const fetchData = async () => {
//       try {
//         // Add timestamp to bust cache — forces fresh data every time
...
//         // Assignment status — now updates instantly after delete
//         const assignmentData = assignRes.data || {};
//         // setHasSubmittedAssignment(!!assignmentData[courseType]);
//         setHasSubmittedAssignment(!!assignmentData[courseType]?.submittedAt);



//         // Exam result
//         const result = examRes.data.results?.find(
//           (r) => r.courseType === courseType
//         );
//         setExamResult(result || null);

//         // Modules from dashboard
//         const allModules = dashRes.data.modules || [];
...
//         toast.error("Failed to load latest data. Try refreshing.");
//       } finally {
//         setLoading(false);
//       }
//     };
...
//     fetchData();
//   }, [courseType]); // Re-run when courseType changes
...
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ delay: 0.2 }}
//             className="backdrop-blur-xl bg-linear-to-br from-emerald-500/20 via-teal-500/20 to-cyan-500/20 rounded-3xl shadow-xl border border-emerald-300/40 p-8"
//           >
...
//               </div>
//               <h3 className="text-2xl font-bold text-gray-800 mb-3">Final Assignment</h3>
//               <p className="text-gray-600 mb-8">One-time submission</p>
//               {hasSubmittedAssignment ? (
//                 <div className="inline-flex items-center gap-4 px-10 py-5 bg-emerald-500 text-white font-bold text-xl rounded-3xl shadow-lg">
...
//                   whileTap={{ scale: 0.95 }}
//                   onClick={() => navigate("/assignment")}
//                   className="inline-flex items-center gap-4 px-10 py-6 bg-linear-to-r from-emerald-500 to-teal-600 text-white font-bold text-xl rounded-3xl shadow-2xl"
//                 >
...
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ delay: 0.3 }}
//             className="backdrop-blur-xl bg-linear-to-br from-purple-500/20 via-fuchsia-500/20 to-pink-500/20 rounded-3xl shadow-xl border border-purple-300/40 p-8"
//           >
//             <div className="flex flex-col items-center justify-center h-full text-center">
//               <div className="p-5 bg-purple-100 rounded-full mb-5">
//                 <FiBookOpen className="text-5xl text-purple-600" />
//               </div>
//               <h3 className="text-2xl font-bold text-gray-800 mb-3">Final Exam</h3>
//               <p className="text-gray-600 mb-8">One-time exam</p>
//               {examResult ? (
//                 <div className={`inline-flex items-center gap-4 px-10 py-5 rounded-3xl shadow-lg font-bold text-xl text-white ${examResult.passed ? "bg-emerald-500" : "bg-red-500"}`}>
//                   <FiCheckCircle className="text-3xl" />
//                   {examResult.passed ? "PASSED" : "FAILED"} ({examResult.score}%)
...
//                   whileTap={{ scale: 0.95 }}
//                   onClick={() => navigate(`/final-exam/${courseType}`)}
//                   className="inline-flex items-center gap-4 px-10 py-6 bg-linear-to-r from-purple-500 to-pink-600 text-white font-bold text-xl rounded-3xl shadow-2xl"
//                 >
...
//             className="backdrop-blur-xl bg-white/70 rounded-3xl shadow-xl border border-white/30 p-6 h-full"
//           >
//             <div className="flex items-center justify-between mb-4">
//               <div className="p-4 bg-indigo-100 rounded-2xl"><FiBarChart2 className="text-indigo-600 text-3xl" /></div>
//               <span className="text-3xl font-bold text-indigo-600">{progressPercentage}%</span>
//             </div>
//             <h3 className="font-bold text-gray-800 text-lg mb-4">Course Progress</h3>
//             <div className="w-full bg-gray-200/70 rounded-full h-3 overflow-hidden mb-4">
//               <motion.div initial={{ width: 0 }} animate={{ width: `${progressPercentage}%` }} transition={{ duration: 1.5, ease: "easeOut" }} className="h-full bg-linear-to-r from-indigo-500 to-purple-600 rounded-full" />
//             </div>
//             <p className="text-gray-600 font-medium">{completedModules} / {totalModules} modules completed</p>
//           </motion.div>
...
//             className="backdrop-blur-xl bg-linear-to-br from-amber-500/20 to-orange-500/20 rounded-3xl shadow-xl border border-amber-200/50 p-6 h-full"
//           >
//             <div className="flex items-center gap-3 mb-4">
//               <div className="p-4 bg-amber-100 rounded-2xl"><FiTarget className="text-amber-600 text-3xl" /></div>
//               <h3 className="font-bold text-gray-800 text-lg">Next Up</h3>
//             </div>
//             <p className="font-bold text-2xl text-gray-800">{nextModule?.title || "All modules completed!"}</p>
//           </motion.div>
...
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ delay: 0.2 }}
//             className="flex flex-col items-center text-center backdrop-blur-xl bg-linear-to-br from-emerald-500/20 via-teal-500/20 to-cyan-500/20 rounded-3xl shadow-xl border border-emerald-300/40 p-6 h-full"
//           >
//             <div className="p-5 bg-emerald-100 rounded-full mb-5">
//               <FiFileText className="text-5xl text-emerald-600" />
//             </div>
//             <h3 className="text-2xl font-bold text-gray-800 mb-3">Final Assignment</h3>
//             <p className="text-gray-600 mb-6">One-time submission</p>
//             {hasSubmittedAssignment ? (
//               <div className="inline-flex items-center gap-2 px-8 py-3 bg-emerald-500 text-white font-bold text-lg rounded-2xl shadow-lg">
//                 <FiCheckCircle className="text-2xl" /> Submitted
//               </div>
//             ) : (
//               <motion.button
//                 whileHover={{ scale: 1.05 }}
//                 whileTap={{ scale: 0.95 }}
//                 onClick={() => navigate("/assignment")}
//                 className="inline-flex items-center gap-2 px-8 py-3 bg-linear-to-r from-emerald-500 to-teal-600 text-white font-bold text-lg rounded-2xl shadow-2xl"
//               >
//                 <FiUpload className="text-2xl" /> Submit
//               </motion.button>
//             )}
//           </motion.div>
...
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ delay: 0.3 }}
//             className="flex flex-col items-center text-center backdrop-blur-xl bg-linear-to-br from-purple-500/20 via-fuchsia-500/20 to-pink-500/20 rounded-3xl shadow-xl border border-purple-300/40 p-6 h-full"
//           >
//             <div className="p-5 bg-purple-100 rounded-full mb-5">
//               <FiBookOpen className="text-5xl text-purple-600" />
//             </div>
//             <h3 className="text-2xl font-bold text-gray-800 mb-3">Final Exam</h3>
//             <p className="text-gray-600 mb-6">One-time exam</p>
//             {examResult ? (
//               <div className={`inline-flex items-center gap-2 px-8 py-3 rounded-2xl shadow-lg font-bold text-lg text-white ${examResult.passed ? "bg-emerald-500" : "bg-red-500"}`}>
...
//                 whileTap={{ scale: 0.95 }}
//                 onClick={() => navigate(`/final-exam/${courseType}`)}
//                 className="inline-flex items-center gap-2 px-8 py-3 bg-linear-to-r from-purple-500 to-pink-600 text-white font-bold text-lg rounded-2xl shadow-2xl"
//               >
//                 <FiAward className="text-2xl" /> Start Exam
//               </motion.button>
//             )}
//           </motion.div>
...
//         {/* === PREMIUM 4-CARD STATS SECTION === */}
// <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">

//   {/* 1. Course Progress – Stunning Gradient */}
//   <motion.div
//     initial={{ opacity: 0, y: 40 }}
//     animate={{ opacity: 1, y: 0 }}
//     transition={{ delay: 0.2, duration: 0.8 }}
//     className="relative group overflow-hidden bg-linear-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-3xl shadow-2xl text-white p-8 transform hover:scale-[1.03] transition-all duration-500"
//   >
...
//           <p className="text-6xl font-black drop-shadow-lg">{progressPercentage}<span className="text-4xl">%</span></p>
//         </div>
//       </div>

//       <h3 className="text-2xl font-extrabold mb-4 tracking-tight">Course Progress</h3>

//       <div className="w-full bg-white/30 rounded-full h-5 overflow-hidden shadow-inner">
//         <motion.div
//           initial={{ width: 0 }}
//           animate={{ width: `${progressPercentage}%` }}
//           transition={{ duration: 2, ease: "easeOut" }}
//           className="h-full bg-linear-to-r from-yellow-400 to-pink-400 rounded-full relative overflow-hidden"
//         >
...
//     <div className="absolute bottom-4 left-4 text-white/30 text-7xl font-black select-none">%</div>
//   </motion.div>

//   {/* 2. Next Module – Motivational & Clean */}
//   <motion.div
//     initial={{ opacity: 0, y: 40 }}
//     animate={{ opacity: 1, y: 0 }}
//     transition={{ delay: 0.3, duration: 0.8 }}
//     className="relative bg-linear-to-br from-amber-400 via-orange-500 to-red-500 rounded-3xl shadow-2xl text-white p-8 overflow-hidden group hover:shadow-3xl transition-all duration-500"
//   >
...
//     <div className="relative z-10">
//       <div className="flex items-center gap-4 mb-6">
//         <div className="p-4 bg-white/20 backdrop-blur-md rounded-2xl shadow-xl group-hover:rotate-12 transition-transform">
//           <FiTarget className="text-4xl" />
//         </div>
//         <h3 className="text-2xl font-extrabold">Next Lesson</h3>
//       </div>

//       <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/20 min-h-32 flex items-center justify-center">
//         <p className="text-xl font-bold text-center leading-relaxed">
//           {nextModule?.title || "All modules completed! You're a star!"}
//         </p>
//       </div>
...
//           {[...Array(3)].map((_, i) => (
//             <div key={i} className="w-10 h-10 bg-white/30 rounded-full border-3 border-white"></div>
//           ))}
//         </div>
//         <p className="text-lg font-medium opacity-90">
//           {nextModule ? "Ready when you are" : "Certificate awaits!"}
//         </p>
//       </div>
//     </div>

//     {nextModule && (
//       <div className="absolute top-4 right-4 bg-white/20 backdrop-blur px-5 py-2 rounded-full font-bold text-sm animate-pulse">
//         NEXT UP
//       </div>
//     )}
//   </motion.div>

//   {/* 3. Final Assignment – Elegant */}
//   <motion.div
//     initial={{ opacity: 0, y: 40 }}
//     animate={{ opacity: 1, y: 0 }}
//     transition={{ delay: 0.4, duration: 0.8 }}
//     className="relative bg-linear-to-br from-emerald-500/20 to-teal-600/20 backdrop-blur-xl rounded-3xl shadow-2xl border border-emerald-300/40 p-8 text-center group hover:shadow-3xl transition-all"
//   >
//     <div className="p-5 bg-emerald-100 rounded-full w-fit mx-auto mb-6 group-hover:scale-110 transition-transform">
//       <FiFileText className="text-5xl text-emerald-600" />
//     </div>

//     <h3 className="text-2xl font-extrabold text-gray-800 mb-3">Final Assignment</h3>
//     <p className="text-gray-600 mb-8 text-sm">One-time submission required</p>

//     {hasSubmittedAssignment ? (
//       <div className="inline-flex items-center gap-3 px-10 py-5 bg-emerald-600 text-white font-bold text-xl rounded-3xl shadow-xl animate-pulse">
//         <FiCheckCircle className="text-3xl" />
//         Submitted
//       </div>
//     ) : (
...
//         whileTap={{ scale: 0.95 }}
//         onClick={() => navigate("/assignment")}
//         className="inline-flex items-center gap-3 px-10 py-5 bg-linear-to-r from-emerald-600 to-teal-700 text-white font-bold text-xl rounded-3xl shadow-2xl hover:shadow-emerald-500/50 transition-all"
//       >
//         <FiUpload className="text-3xl" />
//         Submit Now
//       </motion.button>
...
//   {/* 4. Final Exam – Premium Look */}
//   <motion.div
//     initial={{ opacity: 0, y: 40 }}
//     animate={{ opacity: 1, y: 0 }}
//     transition={{ delay: 0.5, duration: 0.8 }}
//     className="relative bg-linear-to-br from-purple-500/20 via-pink-500/20 to-rose-500/20 backdrop-blur-xl rounded-3xl shadow-2xl border border-purple-300/40 p-8 text-center group hover:shadow-3xl transition-all"
//   >
//     <div className="p-5 bg-purple-100 rounded-full w-fit mx-auto mb-6 group-hover:scale-110 transition-transform">
//       <FiBookOpen className="text-5xl text-purple-600" />
//     </div>

//     <h3 className="text-2xl font-extrabold text-gray-800 mb-3">Final Exam</h3>
//     <p className="text-gray-600 mb-8 text-sm">Prove your mastery</p>

//     {examResult ? (
//       <div className={`inline-flex items-center gap-3 px-10 py-5 rounded-3xl shadow-xl font-bold text-xl text-white ${examResult.passed ? "bg-emerald-600" : "bg-red-600"} animate-pulse`}>
//         <FiAward className="text-3xl" />
...
//         whileTap={{ scale: 0.95 }}
//         onClick={() => navigate(`/final-exam/${courseType}`)}
//         className="inline-flex items-center gap-3 px-10 py-5 bg-linear-to-r from-purple-600 to-pink-600 text-white font-bold text-xl rounded-3xl shadow-2xl hover:shadow-purple-500/50 transition-all"
//       >
//         <FiAward className="text-3xl" />
//         Start Exam
//       </motion.button>
...
// {/* === ULTRA PROFESSIONAL 4-CARD STATS — NO ANIMATION ON SUBMITTED/PASSED === */}
// <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
...
//     animate={{ opacity: 1, y: 0 }}
//     transition={{ delay: 0.2, duration: 0.8 }}
//     className="relative overflow-hidden bg-linear-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-3xl shadow-2xl text-white p-8 hover:shadow-3xl transition-shadow duration-500"
//   >
...
//           <FiBarChart2 className="text-4xl" />
//         </div>
//         <p className="text-6xl font-black">{progressPercentage}<span className="text-4xl">%</span></p>
//       </div>
...
//     animate={{ opacity: 1, y: 0 }}
//     transition={{ delay: 0.3, duration: 0.8 }}
//     className="bg-linear-to-br from-amber-400 via-orange-500 to-red-500 rounded-3xl shadow-2xl text-white p-8 hover:shadow-3xl transition-shadow duration-500"
...
//     <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/20 min-h-28 flex items-center">
...
//   {/* 3. Final Assignment — NO ANIMATION */}
//   <motion.div
//     initial={{ opacity: 0, y: 40 }}
//     animate={{ opacity: 1, y: 0 }}
//     transition={{ delay: 0.4, duration: 0.8 }}
//     className="bg-linear-to-br from-emerald-500/20 to-teal-600/20 backdrop-blur-xl rounded-3xl shadow-2xl border border-emerald-300/40 p-8 text-center hover:shadow-3xl transition-shadow"
//   >
//     <div className="p-5 bg-emerald-100 rounded-full w-fit mx-auto mb-6">
//       <FiFileText className="text-5xl text-emerald-600" />
//     </div>
//     <h3 className="text-2xl font-extrabold text-gray-800 mb-3">Final Assignment</h3>
//     <p className="text-gray-600 mb-8 text-sm">One-time submission</p>
...
//   {/* 4. Final Exam — NO ANIMATION ON RESULT */}
//   <motion.div
//     initial={{ opacity: 0, y: 40 }}
//     animate={{ opacity: 1, y: 0 }}
//     transition={{ delay: 0.5, duration: 0.8 }}
//     className="bg-linear-to-br from-purple-500/20 via-pink-500/20 to-rose-500/20 backdrop-blur-xl rounded-3xl shadow-2xl border border-purple-300/40 p-8 text-center hover:shadow-3xl transition-shadow"
//   >
...
// <h2 className="text-4xl font-black leading-tight mb-6 bg-linear-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent inline-block">
//   Your Learning Material and Quiz
// </h2>

//         {/* Progress Stats */}
//         {/* {modules.length > 0 && (
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
//             <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="backdrop-blur-xl bg-white/70 rounded-3xl shadow-xl border border-white/30 p-8">
//               <div className="flex items-center justify-between mb-6">
//                 <div className="p-4 bg-indigo-100 rounded-2xl"><FiBarChart2 className="text-indigo-600 text-3xl" /></div>
//                 <span className="text-4xl font-bold text-indigo-600">{progressPercentage}%</span>
//               </div>
//               <h3 className="font-bold text-gray-800 text-xl mb-4">Course Progress</h3>
//               <div className="w-full bg-gray-200/70 rounded-full h-4 overflow-hidden mb-4">
//                 <motion.div initial={{ width: 0 }} animate={{ width: `${progressPercentage}%` }} transition={{ duration: 1.5, ease: "easeOut" }} className="h-full bg-linear-to-r from-indigo-500 to-purple-600 rounded-full" />
//               </div>
//               <p className="text-gray-600 font-medium">{completedModules} / {totalModules} modules completed</p>
...
//             <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="backdrop-blur-xl bg-linear-to-br from-amber-500/20 to-orange-500/20 rounded-3xl shadow-xl border border-amber-200/50 p-8">
//               <div className="flex items-center gap-4 mb-6">
//                 <div className="p-4 bg-amber-100 rounded-2xl"><FiTarget className="text-amber-600 text-3xl" /></div>
//                 <h3 className="font-bold text-gray-800 text-xl">Next Up</h3>
//               </div>
...
//                   whileHover={{ scale: isLocked ? 1 : 1.02 }}
//                   className={`relative overflow-hidden rounded-3xl shadow-2xl border-4 transition-all duration-500
//                     ${isCompleted ? "bg-linear-to-br from-emerald-500/10 to-teal-500/10 border-emerald-500" :
//                       isNext ? "bg-linear-to-br from-amber-500/20 to-orange-500/20 border-amber-500 shadow-2xl ring-4 ring-amber-300/50" :
//                         "bg-white/90 backdrop-blur border-gray-300 opacity-90"
//                     }`}
//                 >
//                   {/* Status Badges */}
//                   <div className="absolute top-6 right-6 z-10 flex flex-col gap-3 items-end">
//                     {isCompleted && <span className="px-6 py-3 rounded-full bg-emerald-500 text-white font-bold shadow-lg text-sm uppercase tracking-wider">Completed</span>}
//                     {mod.score !== null && <span className={`px-5 py-3 rounded-full text-white font-bold shadow-lg text-sm ${mod.score === mod.total ? "bg-emerald-600" : "bg-orange-600"}`}>{mod.score}/{mod.total}</span>}
//                     {isNext && !isCompleted && <span className="px-6 py-3 rounded-full bg-linear-to-r from-amber-500 to-orange-500 text-white font-bold shadow-lg animate-pulse text-sm uppercase tracking-wider">Next Up</span>}
//                     {isLocked && <span className="px-6 py-3 rounded-full bg-gray-500 text-white font-bold shadow-lg text-sm uppercase tracking-wider">Locked</span>}
//                   </div>
...
//                       <div className="text-6xl font-black text-indigo-700">#{index + 1}</div>
//                       <div>
//                         <h2 className={`text-4xl font-bold mb-3 ${isLocked ? "text-gray-500" : "text-gray-800"}`}>{mod.title}</h2>
//                         <p className={`text-xl leading-relaxed ${isLocked ? "text-gray-500 italic" : "text-gray-600"}`}>{mod.description}</p>
//                       </div>
//                     </div>
...
//                       <div className="space-y-8 mb-10">
//                         {mod.materials.map((mat, i) => {
//                           const isVideo = mat.materialType === "video" && (mat.url.includes("youtube") || mat.url.includes("vimeo"));
//                           if (isLocked) return <div key={i} className="text-gray-500 italic">Content locked</div>;
//                           if (isVideo) return (
//                             <motion.div key={i} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-200">
//                               <div className="p-6 bg-linear-to-r from-indigo-50 to-purple-50">
//                                 <h4 className="text-2xl font-bold text-indigo-700 mb-4">Video {i + 1} — {mat.title}</h4>
//                                 <div className="aspect-video rounded-2xl overflow-hidden shadow-lg">
...
//                               className="inline-flex items-center gap-4 px-10 py-6 bg-linear-to-r from-indigo-600 to-purple-700 text-white rounded-3xl font-bold text-xl shadow-xl hover:shadow-2xl transition-all hover:scale-105"
//                             >
//                               {mat.materialType === "pdf" ? "PDF Document" : "External Link"}
//                             </motion.a>
//                           );
//                         })}
//                       </div>
...
//       {/* LEFT: Videos (Big & Beautiful) */}
//       <div className="space-y-8">
//         {mod.materials
//           .filter(mat => mat.materialType === "video")
//           .map((mat, i) => (
//             <motion.div
//               key={i}
...
//             >
//               <div className="p-6 bg-linear-to-r from-indigo-50 to-purple-50 border-b border-indigo-100">
//                 <h4 className="text-2xl font-bold text-indigo-700 flex items-center gap-3">
//                   Video {i + 1} — {mat.title || "Lesson Video"}
//                 </h4>
//               </div>
...
//         {mod.materials.filter(mat => mat.materialType === "video").length === 0 && (
//           <div className="text-center py-16 text-gray-500">
//             <FiAward className="mx-auto text-6xl mb-4 text-gray-300" />
//             <p className="text-xl">No videos in this module</p>
//           </div>
//         )}
//       </div>

//       {/* RIGHT: PDF & Links (Clean Buttons) */}
//       <div className="space-y-6">
//         <h4 className="text-xl font-bold text-gray-700 mb-6 flex items-center gap-3">
...
//             >
//               <div className="bg-linear-to-r from-purple-600 to-indigo-700 text-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
...
//                           <path fillRule="evenodd" d="M12.586 4.586a2 2 0 112.828 2.828l-3 3a2 2 0 01-2.828 0 2 2 0 012.828-2.828zM4 10a6 6 0 1012 0 6 6 0 00-12 0z" clipRule="evenodd" />
//                         </svg>
//                       )}
//                     </div>
//                     <div>
//                       <p className="text-xl font-bold">
//                         {mat.title || (mat.materialType === "pdf" ? "PDF Document" : "External Resource")}
//                       </p>
...
//                     </div>
//                   </div>
//                   <div className="text-3xl opacity-70 group-hover:opacity-100 group-hover:translate-x-2 transition-all">
//                     →
//                   </div>
//                 </div>
//               </div>
...
//         {mod.materials.filter(mat => mat.materialType !== "video").length === 0 && (
//           <div className="text-center py-16 text-gray-500">
//             <FiStar className="mx-auto text-6xl mb-4 text-gray-300" />
//             <p className="text-xl">No additional resources</p>
//           </div>
//         )}
//       </div>
//     </div>
...
//         <p className="text-2xl font-bold text-gray-600">This content is locked</p>
//         <p className="text-lg text-gray-500 mt-3">Complete previous modules to unlock</p>
//       </div>
//     )}
//   </div>
// )}
...
//                     <div className="flex justify-end gap-6 mt-10">
//                       {isCompleted && mod.hasQuiz ? (
//                         <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={() => navigate(`/quiz/review/${mod._id}`)} className="px-10 py-5 rounded-3xl font-bold text-xl flex items-center gap-4 bg-linear-to-r from-blue-500 to-cyan-600 text-white shadow-xl">
//                           <FiBookOpen size={28} /> Review Quiz
//                         </motion.button>
//                       ) : isLocked ? (
//                         <button disabled className="px-10 py-5 rounded-3xl font-bold text-xl bg-gray-300 text-gray-600 cursor-not-allowed flex items-center gap-4">
...
//                         </button>
//                       ) : mod.hasQuiz ? (
//                         <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={() => navigate(`/quiz/module/${mod._id}`)} className="px-10 py-5 rounded-3xl font-bold text-xl flex items-center gap-4 bg-linear-to-r from-emerald-500 to-teal-600 text-white shadow-xl">
//                           <FiAward size={28} /> Start Quiz
//                         </motion.button>
//                       ) : (
//                         <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={() => navigate("/student", { state: { highlightModuleId: mod._id } })} className="px-10 py-5 rounded-3xl font-bold text-xl bg-linear-to-r from-indigo-600 to-purple-700 text-white shadow-xl">
//                           View Content
//                         </motion.button>
//                       )}
//                     </div>
